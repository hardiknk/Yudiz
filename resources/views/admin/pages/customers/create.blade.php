...
@section('content')
    <div class="container">
        <div class="card card-custom">
            ...
            <!--begin::Form-->
            <form id="frmAddCustomers" method="POST" action="{{ route('admin.customers.store') }}"
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('admin.customers.index') }}" class="btn btn-secondary text-uppercase">Cancel</a>
                </div>
            </form>
            <!--end::Form-->
        </div>
...
@push('extra-js-scripts')
    <script>
        $(document).ready(function() {
            ...
            $('#frmAddCustomers').submit(function() {
                if ($(this).valid()) {
                    addOverlay();
